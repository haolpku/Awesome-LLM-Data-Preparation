...
<p align="center">
  <img src="assets/cover.png" alt="封面 — 大语言模型数据准备" width="92%" />
</p>
...
<p>
  ...
  <a href="https://link.springer.com/article/10.1007/s11390-026-5948-8">📄 论文原文 (Springer)</a> ·
...
- **2026.03** — 综述论文正式发表于 *Journal of Computer Science and Technology*（JCST），**2026 年第 41 卷第 1 期，289–317 页**。📖 [Springer 原文](https://link.springer.com/article/10.1007/s11390-026-5948-8) · DOI: [`10.1007/s11390-026-5948-8`](https://doi.org/10.1007/s11390-026-5948-8)。
- **2025.10** — v0.1 仓库发布，作为综述的配套资源。
...
<!-- 分类体系总览图 -->
<p align="center">
  <img src="assets/structure.png" alt="大语言模型数据准备分类体系" width="92%" />
</p>
